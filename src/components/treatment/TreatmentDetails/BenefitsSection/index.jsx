            ...
            <section className="pb-32">
                <div className="container w-full h-auto flex flex-col gap-11 items-center">
                    <div className="max-w-[984px] w-full flex flex-col text-center gap-3">
                        <h2 className="text-foreground text-3xl 2xl:text-5xl leading-14 2xl:leading-16 ">Benefits of
                            <span className="text-autumn-leaves text-2xl 2xl:text-4xl italic">{" "}Treatment</span></h2>
                    ...
                    <div className="flex flex-col gap-14 2xl:gap-16 w-full">
                        {growData.map((item, index) => (
                            <div
                                key={index}
                                className={`flex items-center gap-8 2xl:gap-10 ${index % 2 === 0
                                        ? "flex-row"
                                        : "flex-row-reverse"
                                    }`}
                            >
