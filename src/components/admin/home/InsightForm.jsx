...
const InsightForm = ({ defaultValues = {}, mode = "create" }) => {
  console.log("Default Values in Insight Form=========>", defaultValues);
  const router = useRouter();
  const { addInsight, updateInsight, loading } = useInsights();
  ...
  const onSubmit = async (data) => {
    if (mode === "edit") {
      ...
      await updateInsight(defaultValues.id, data);
    } else if (mode === "create") {
      await addInsight(data);
    }
